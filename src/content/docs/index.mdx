...
- CPDLC in Practice, André Lehto & Isak Sestorp, 2019
...
The terms "JSON", "JSON text", "JSON value", "member", "element", "object", "array", "number", "string", "boolean", "true", "false", and "null" on this website are to be interpreted as defined in [RFC 8259](https://datatracker.ietf.org/doc/rfc8259/).

The terms "WebSocket", "WebSocket handshake", and "WebSocket connection" on this website are to be interpreted as defined in [RFC 6455](https://datatracker.ietf.org/doc/rfc6455/).
