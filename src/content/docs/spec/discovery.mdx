...
2. Provider client responds with the following JSON payload:
    ...
    The `provider.features` field shall be populated with a list of all features supported by the provider client. Refer to the [Features](/features) page for a list of features and how they should be represented in this field.
</Steps>
